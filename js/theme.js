...
import { animateThemeToggle } from './animations.js';
...
export function applyTheme(t, animate=false){
...
export function toggleTheme(){ applyTheme(effectiveTheme()==='dark' ? 'light':'dark', true); }
